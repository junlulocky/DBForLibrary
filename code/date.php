<table width="190" height="180" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#6495ED">
        <tr>
          <td valign="top" bgcolor="#FFFFFF"><table width="190" height="24" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td background="images/veriline.gif">&nbsp;&nbsp;<img src="images/biao.gif" width="10" height="9">&nbsp;ÍòÄêÀú</td>
              </tr>
            </table>
