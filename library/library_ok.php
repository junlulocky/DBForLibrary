...
if($query==true){
	echo "<script language=javascript>alert('Library information modification success!');history.back();</script>";
}else{
	echo "<script language=javascript>alert('Library information modification failed!');history.back();</script>";
}
}
?>
