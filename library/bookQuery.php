...
function check(myform){
	...
	if (myform.flag2.checked){
		if(myform.sdate.value==""){
			alert("Please enter an start date");myform.sdate.focus();return false;
		}		
	...
	if (myform.flag3.checked){
		if(myform.lprice.value==""){
			alert("Please enter an start price");myform.lprice.focus();return false;
		}		
  ...
  <tr>
    <td height="510" align="center" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center" valign="top">
	      <table width="723" height="37" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <span class="word_orange">Current Location: System Query > Library File Search>>></span> 
        ...
        <option value="<?php echo "book_id";?>">Book NO:</option>
        ...
        <option value="<?php echo "press";?>">Press</option>
                ...
                <input name="Submit" type="submit" class="btn_grey" value="²éÑ¯" onClick="return check(form1);"></td>
              </tr>
              <tr>
                <td height="26">
