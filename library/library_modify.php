...
?>
  ...
  <tr align="center">
    ...
    <tr>
      <td align="left" style="padding:5px;"> E-mail£º </td>
    ...
    <tr>
      ...
      <td>        &nbsp;
          <input name="Submit" type="submit" class="btn_grey" id="Submit" value="±£´æ" onClick="return checkForm(form1)">
          <input name="Submit2" type="reset" class="btn_grey" id="Submit2" value="È¡Ïû">
      </td>
    </tr>
</table>
</form>
