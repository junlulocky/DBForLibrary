...
<link href="CSS/style.css" rel="stylesheet">
		...
		function checkreader(form){
			if(form.barcode.value==""){
				alert("Please enter the reader ID!");form.barcode.focus();return;
			}
			form.submit();
		}
		function checkbook(form){
			...
			if(form.inputkey.value==""){
				alert("Please enter query keyword!");form.inputkey.focus();return;
			}
        form.submit();
	   }
		</script>
...
<table width="776"  border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <tr>
    <td align="left" valign="top" style="padding:5px;"> &nbsp; <span class="word_orange">&nbsp;Current Location: Books borrow&return &gt; Borrow&gt;&gt;&gt; </span>      
        ...
        <tr>
          ...
          <tr>
              <td height="33" valign="top" background="images/bookborr.gif">
                 ...
                 <tr>
                 <td width="92%" align="center">Reader ID:</td>
                 </tr>
               </tr>
               <tr>
               ...
               <tr>
                 ...
                 <tr>
                   <td height="32">&nbsp;Why:
                     ...
                     Book number (please refer to the book and file management) &nbsp;&nbsp;
            ...
            <tr>
              <td valign="top" bgcolor="#D2E5F1" style="padding:5px"><table width="99%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#9ECFEE" bgcolor="#FFFFFF">
                     <tr align="center" bgcolor="#E2F4F6">
                       <td width="29%" height="25">Book Title</td>
                       <td width="12%">Borrow Date</td>
                       <td width="14%">Return Date</td>
                       <td width="17%">Press</td>
                       <td width="14%">Author</td>
                       <td colspan="2">Price(dollar)</td>
                     </tr>
<?php
