...
function check(form){
	if(form.barcode.value==""){
		alert("Please enter the book number!");form.barcode.focus();return false;
	}
	if(form.bookName.value==""){
		alert("Please enter a book name!");form.bookName.focus();return false;
	}
	if(form.price.value==""){
		alert("Please enter a book pricing!");form.price.focus();return false;
	}
form.submit();
}
</script>
...
<table width="776" border="0" align="center" cellpadding="0" cellspacing="0" class="tableBorder">
  ...
  <tr>
    <td height="473" align="center" valign="top" style="padding:5px;"><table width="98%" height="463"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22" valign="top" class="word_orange">Current Location: Book and file management &gt; Edit book information &gt;&gt;&gt;</td>
      </tr>
      <tr>
  ...
  <tr>
    ...
    <table width="600" height="397"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        <td height="35" align="center">Category:</td>
        <td>
